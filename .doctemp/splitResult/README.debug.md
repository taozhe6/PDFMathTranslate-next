<!-- CHUNK ID: chunk_838C5468  CHUNK TYPE: paragraph START_LINE:1 -->
<div align="center">
...
<!-- CHUNK ID: chunk_360B5F41  CHUNK TYPE: html_comment START_LINE:15 -->
...
<!-- CHUNK ID: chunk_2D1CFDA0  CHUNK TYPE: html_comment START_LINE:17 -->
  <!-- <a href="https://huggingface.co/spaces/reycn/PDFMathTranslate-Docker">
    <img src="https://img.shields.io/badge/%F0%9F%A4%97-Online%20Demo-FF9E0D"></a> -->
<!-- CHUNK ID: chunk_F58C27F2  CHUNK TYPE: html_comment START_LINE:19 -->
  <!-- <a href="https://www.modelscope.cn/studios/AI-ModelScope/PDFMathTranslate"> -->
<!-- CHUNK ID: chunk_4BF46740  CHUNK TYPE: html_comment START_LINE:20 -->
    <!-- <img src="https://img.shields.io/badge/ModelScope-Demo-blue"></a> -->
<!-- CHUNK ID: chunk_53C5F9CB  CHUNK TYPE: html_comment START_LINE:21 -->
  <!-- <a href="https://github.com/PDFMathTranslate-next/PDFMathTranslate-next/pulls">
    <img src="https://img.shields.io/badge/contributions-welcome-green"></a> -->
<!-- CHUNK ID: chunk_524DFC76  CHUNK TYPE: paragraph START_LINE:23 -->
  <a href="https://t.me/+Z9_SgnxmsmA5NzBl">
<!-- CHUNK ID: chunk_C8740F43  CHUNK TYPE: image START_LINE:24 -->
    <img src="https://img.shields.io/badge/Telegram-2CA5E0?style=flat-squeare&logo=telegram&logoColor=white"></a>
<!-- CHUNK ID: chunk_9F43F425  CHUNK TYPE: html_comment START_LINE:25 -->
  <!-- License -->
<!-- CHUNK ID: chunk_63D768E7  CHUNK TYPE: paragraph START_LINE:26 -->
  <a href="./LICENSE">
<!-- CHUNK ID: chunk_9F3F53BD  CHUNK TYPE: image START_LINE:27 -->
    <img src="https://img.shields.io/github/license/PDFMathTranslate-next/PDFMathTranslate-next"></a>
<!-- CHUNK ID: chunk_98431446  CHUNK TYPE: paragraph START_LINE:28 -->
  <a href="https://hosted.weblate.org/engage/pdfmathtranslate-next/">
<!-- CHUNK ID: chunk_E9D822B5  CHUNK TYPE: image START_LINE:29 -->
    <img src="https://hosted.weblate.org/widget/pdfmathtranslate-next/svg-badge.svg" alt="translation status" /></a>
<!-- CHUNK ID: chunk_A2EBE043  CHUNK TYPE: paragraph START_LINE:30 -->
...
<!-- CHUNK ID: chunk_9DA5FEDD  CHUNK TYPE: paragraph START_LINE:35 -->
</div>
...
<!-- CHUNK ID: chunk_13EE773D  CHUNK TYPE: html_comment START_LINE:43 -->
...
<!-- CHUNK ID: chunk_9DB1D4F2  CHUNK TYPE: blockquote START_LINE:45 -->
> [!WARNING]
>
...
<!-- CHUNK ID: chunk_CAEA8F3C  CHUNK TYPE: paragraph START_LINE:52 -->
...
<div align="center">
<!-- CHUNK ID: chunk_FF589225  CHUNK TYPE: html_comment START_LINE:57 -->
<!-- <img src="./docs/images/preview.gif" width="80%"  alt="preview"/> -->
<!-- CHUNK ID: chunk_CF255FF9  CHUNK TYPE: image START_LINE:58 -->
<img src="https://s.immersivetranslate.com/assets/r2-uploads/images/babeldoc-preview.png" width="80%"/>
<!-- CHUNK ID: chunk_C7B63F0F  CHUNK TYPE: paragraph START_LINE:59 -->
</div>
...
<!-- CHUNK ID: chunk_F86E0964  CHUNK TYPE: list START_LINE:65 -->
...
<!-- CHUNK ID: chunk_C20CF59D  CHUNK TYPE: paragraph START_LINE:67 -->
<h2 id="install">Installation and Usage</h2>

<!-- CHUNK ID: chunk_36D1B1ED  CHUNK TYPE: header START_LINE:69 -->
### Installation

<!-- CHUNK ID: chunk_545A02FF  CHUNK TYPE: list START_LINE:71 -->
...
<!-- CHUNK ID: h_rule_b23ccc52  CHUNK TYPE: h_rule START_LINE:75 -->
---

<!-- CHUNK ID: chunk_047D6F23  CHUNK TYPE: header START_LINE:77 -->
### Usage

<!-- CHUNK ID: chunk_A49D7830  CHUNK TYPE: list START_LINE:79 -->
...
<!-- CHUNK ID: chunk_F57A3EE5  CHUNK TYPE: paragraph START_LINE:83 -->
...
<!-- CHUNK ID: chunk_E3D9081F  CHUNK TYPE: html_comment START_LINE:91 -->
<!-- <!-- For downstream applications, please refer to our document about [API Details](./docs/APIS.md) for futher information about: -->

<!-- CHUNK ID: chunk_7BA06D24  CHUNK TYPE: list START_LINE:93 -->
- [Python API](./docs/en/advanced/API/python.md), how to use the program in other Python programs
<!-- CHUNK ID: chunk_34C1B878  CHUNK TYPE: html_comment START_LINE:94 -->
<!-- - [HTTP API](./docs/APIS.md#api-http), how to communicate with a server with the program installed -->

<!-- CHUNK ID: chunk_7512C664  CHUNK TYPE: paragraph START_LINE:96 -->
...
<!-- CHUNK ID: chunk_C0AB99E6  CHUNK TYPE: list START_LINE:102 -->
...
<!-- CHUNK ID: chunk_1E68B134  CHUNK TYPE: paragraph START_LINE:130 -->
...
<!-- CHUNK ID: chunk_CFE5EC23  CHUNK TYPE: html_comment START_LINE:136 -->
<!-- <a href="https://github.com/PDFMathTranslate-next/PDFMathTranslate-next/graphs/contributors">
  <img src="https://opencollective.com/PDFMathTranslate/contributors.svg?width=890&button=false" />
</a> -->

<!-- CHUNK ID: chunk_1AEA0966  CHUNK TYPE: html_comment START_LINE:140 -->
<!-- ![Alt](https://repobeats.axiom.co/api/embed/45529651750579e099960950f757449a410477ad.svg "Repobeats analytics image") -->

<!-- CHUNK ID: chunk_3B6B90E0  CHUNK TYPE: paragraph START_LINE:142 -->
...
<!-- CHUNK ID: chunk_A821628C  CHUNK TYPE: image START_LINE:148 -->
...
<!-- CHUNK ID: chunk_64791BB7  CHUNK TYPE: paragraph START_LINE:149 -->
 </picture>
</a>
