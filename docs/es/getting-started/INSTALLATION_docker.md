...
> [!NOTE]
> 
> - Si no puedes acceder a Docker Hub, prueba con la imagen en [GitHub Container Registry](https://github.com/PDFMathTranslate-next/PDFMathTranslate-next/pkgs/container/pdfmathtranslate).
> 
> ```bash
